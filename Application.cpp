...
void Application::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Roast Engine", nullptr, nullptr);
...
void Application::createInstance() {
    ...
    appInfo.pApplicationName = "Roast";
...
VKAPI_ATTR VkBool32 VKAPI_CALL Application::debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity, VkDebugUtilsMessageTypeFlagsEXT messageType, const VkDebugUtilsMessengerCallbackDataEXT* pCallbackData, void* pUserData) {
    ...
    if (messageSeverity >= VK_DEBUG_UTILS_MESSAGE_SEVERITY_WARNING_BIT_EXT) {
        std::cerr << "[VAIDATION LAYER] " << pCallbackData->pMessage << std::endl;
    }
...
void Application::setWindowFPS(GLFWwindow* win) {
    // Measure speed
    ...
    if (currentTime - lastTime >= 1.0) { // If last cout was more than 1 sec ago
        ...
        snprintf(title, 255,
            "%s %s - [FPS: %4.0f]",
            "Roast Engine", "v1.0", (float)nbFrames);
...
void Application::createTextureImage() {
    ...
    stbi_uc* pixels = stbi_load("textures/roast.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
